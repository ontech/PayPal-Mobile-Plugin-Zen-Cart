...
?> 
<?php
// $directory_array = $template->get_template_part($code_page_directory, '/^time_out/');
...
//  }
//	$directory_array = $template->get_template_part(DIR_WS_MODULES . 'pages/time_out', '/^header_php/');
//	$directory_array = $template->get_template_part($code_page_directory, '/^header_php/');
//	echo $directory_array . '<BR/>';
//  foreach ($directory_array as $value) {
...
//	require $value;
//  }
	include ($template->get_template_dir('tpl_time_out_default.php', DIR_WS_TEMPLATES, $current_page_base, 'templates') . '/tpl_time_out_default.php');
