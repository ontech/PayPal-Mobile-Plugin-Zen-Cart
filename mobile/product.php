...
<form method="post" rel="external" action="cart/index.php?action=add_product" class="productform">
	...
	<td style="vertical-align: top;">
		<div style="position: relative; width: 126px; height: 126px;">
			...
			<a href="gallery<?php echo $product_info->fields['products_id']; ?>.htm?products_id=<?php echo $product_info->fields['products_id']; ?>" style="position: absolute; top: 0px; left: 0px; display: block; z-index: 4;"><img class="photo" style="margin-top:3px; margin-left:auto; margin-right:auto;" src="<?php echo htmlspecialchars(mobile_image($product_info->fields['products_image'])); ?>" width="100"/></a>
		</div>
	</td>
