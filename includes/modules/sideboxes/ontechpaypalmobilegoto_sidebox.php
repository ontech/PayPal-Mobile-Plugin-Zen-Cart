...
//			echo 'cook_val = 1';
			...
			$show_ontechpaypalmobilegoto_sidebox = true;
		} elseif ($cook_val == 0) {
//			echo 'cook_val = 0';
			$information[] = '<a href="" onclick="WriteShowDesktopCookie();"/>Return to Mobile Site</a>';
			$show_ontechpaypalmobilegoto_sidebox = true;
...
//			echo 'cook_val = something else';
			$show_ontechpaypalmobilegoto_sidebox = false;
		}
	} else {
		$show_ontechpaypalmobilegoto_sidebox = false;
	}

	if ($show_ontechpaypalmobilegoto_sidebox == true) { //This is to determine if the cookie has been set
		require($template->get_template_dir('tpl_ontechpaypalmobilegoto_sidebox.php',DIR_WS_TEMPLATE,$current_page_base,'sideboxes'). '/tpl_ontechpaypalmobilegoto_sidebox.php');
		$title = BOX_HEADING_ONTECHPAYPALMOBILEGOTO_SIDEBOX;
//		$left_corner = false;
//		$right_corner = false;
//		$right_arrow = false;
